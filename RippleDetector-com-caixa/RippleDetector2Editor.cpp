...
//**************************************************************> significa q veio do Network Events
...
//**************************************************************
/*NetworkEvents2Editor::NetworkEvents2Editor(GenericProcessor* parentNode, bool useDefaultParameterEditors=true)
    : GenericEditor(parentNode, useDefaultParameterEditors)

{
	  NetworkEvents2 *p= (NetworkEvents2 *)getProcessor();

	  labelPort = new Label("Port", String(p->urlport));
    labelPort->setBounds(10,45,50,20);
...
void NetworkEvents2Editor::setLabelColor(juce::Colour color)
{
	labelPort->setColour(Label::backgroundColourId, color);
}

void NetworkEvents2Editor::labelTextChanged(juce::Label *label)
{
	if (label == labelPort)
	{
...
NetworkEvents2Editor::~NetworkEvents2Editor()
{}*/
//**************************************************************
...
//**************************************************************
//-------------------------------------------------------------
    lowCutLabel = new Label("low cut label", "Tempo:");
...
//**************************************************************
void RippleDetector2Editor::setLabelColor(juce::Colour color)
{
	labelPort->setColour(Label::backgroundColourId, color);
}

void RippleDetector2Editor::labelTextChanged(juce::Label *label)
{
	if (label == labelPort)
	{
	   Value val = label->getTextValue();
