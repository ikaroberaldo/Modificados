...
AudioProcessorEditor* RippleDetector2::createEditor()                                                         //__Não sei pra q serve__
{
...
void RippleDetector2::addModule()                                                                             //__Inicializa as variáveis__
{
...
void RippleDetector2::setActiveModule(int i)                                                                  //__Não sei pra q serve__
{
...
//ææ    int numfilt = filters.size();
   
    cout << "------------------------------------------AQUI-12-------------------------------" << endl;
    
    if (numInputs < 1024 /*ææ and numInputs != numfilt*/)
    {
...
//ææ        filters.clear();
        ...
        {
//ææ            filters.add (new Dsp::SmoothedFilterDesign
//ææ                         <Dsp::Butterworth::Design::BandPass    
//ææ                         <2>,                                   
//ææ                         1,                                     
//ææ                         Dsp::DirectFormII> (1));               
...
//ææ    Dsp::Params params;
//ææ    params[0] = channels[chan]->sampleRate; // sample rate
//ææ    params[1] = 2;                          // order
//ææ    params[2] = (highCut + lowCut) / 2;     // center frequency
//ææ    params[3] = highCut - lowCut;           // bandwidth
    
//ææ    if (filters.size() > chan)
//ææ        filters[chan]->setParams (params);
}
...
//ææ            filters[n]->process (getNumSamples (n), &ptr);
    }
}
/*
