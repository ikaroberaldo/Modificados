...
RippleDetector::RippleDetector()
    : GenericProcessor("Ripple Detector"), activeModule(-1), defaultTime(20.0f), defaultAmplitude(2.0f)
{

}
//Constructor (called in the beginning)
...
//Called when it needs to update the number of inputs (called the number of channels the input will have)
